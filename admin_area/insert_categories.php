...
if(isset($_POST['insert_cat'])){
  ...
  $inser_query="insert into `categories`(category_name)values('$category_title')";
  $result=mysqli_query($con,$inser_query);
  if($result){
    echo "<script>
    alert('category has been inserted succesfully')
    </script>";
  }
}
}
...
<div class="input-group w-10 mb-2 m-auto">
  ...
  <input type="submit" class="bg-info border-0 my-2 p-2" name="insert_cat" value="Insert Categories"> 
